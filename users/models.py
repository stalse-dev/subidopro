...
#     pontos = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Pontos')
...
#     class Meta:
#         verbose_name = 'Envio do Aluno'
#         verbose_name_plural = 'Envios dos Alunos'

#     def __str__(self):
#         return f"Envio {self.id} - Aluno {self.vinculoAluno.id}"

#     @property
#     def ajustes(self):
#         return self.ajustes.all()

# class AjustePontos(models.Model):
#     STATUS_CHOICES = [
#         ('pendente', 'Pendente'),
...
#         'AlunoEnvio',  # Substitua pelo nome correto do modelo relacionado
#         on_delete=models.CASCADE,
#         related_name='ajustes'
#     )
#     pontos_ajustados = models.DecimalField(
#         max_digits=10,
#         decimal_places=2,
#         verbose_name='Pontos Ajustados'
#     )
...
#     def __str__(self):
#         return f"Ajuste {self.id} - Envio {self.envio.id} - {self.status}"
