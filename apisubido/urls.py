...
urlpatterns = [
    ...
    path('campeonato/<int:campeonato_id>/', RankingSemanalAPIView.as_view(), name='campeonato'),
    path('cla_campeonato/<int:campeonato_id>/', RankingClaAPIView.as_view(), name='campeonato'),
